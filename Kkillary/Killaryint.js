...
campaignTrail_temp.candidate_json = [
    {
        ...
        "fields": {
            ...
            "state": "New York",
            "priority": 1,
            "description": "<p style= \"font-size: 97%; font-family:helvetica; margin:7px;\">Safe to say, your political career has hardly been stellar.</p><p style= \"font-size: 97%; font-family:helvetica; margin:7px;\">Again and again you failed despite the fact that it <i>should</i> have been easy. Losing what should have been a coronation primary to a freshman Senator in 2008. It was only a matter of time until your inauguration though. A matter of time until he stepped down for you to take his place.</p><p style= \"font-size: 97%; font-family:helvetica; margin:7px;\">You managed to rebound by becoming Secretary of State; just in time to get an ambassador killed in a country most Americans couldn’t point out on a map. Then, you nearly lost the primary to a self-proclaimed <i>socialist</i>. Finally, at the finish line, you had a red mark etched into your legacy, barely scraping by with 2,000 votes against a racist, sexist, tax dodging, reality show host.</p><p style= \"font-size: 97%; font-family:helvetica; margin:7px;\">Seen by the left as a neoliberal shill and by the right as a marxist witch, the task of navigating a world, nation, and party that are each growing out of control seems herculean. But maybe, just this once, you can actually pull off a win without the odds being comically favorable to you.</p>",
            "color_hex": "#0000FF",
