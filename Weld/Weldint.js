...
campaignTrail_temp.candidate_json = [
    {
        ...
        "fields": {
            ...
            "state": "Wyoming",
            "priority": 1,
            "description": "Richard Bruce Cheney is running to set the record straight. And he's not got much time left to do it. America was burning. Its knight was a man hardly fit for military service, a dozen donuts a day and a smoker since the age of twelve—the people could never see him.<br><br>His majesty the Texas nimwit could stir the media into a whiz but didn't have the guts to make and break lives, so the job fell to the veracious American Cowboy, a balding grey haired man from the century past. America rose from the ashes of its enemies. His reward? His heart problems complicating with a man in the White House who couldn't order mens deaths if his life depended on it. Worst part? His margins are Assad while his are ebola. Time to tell the people the ugly truth of what he did for them. Mask off.",
            "color_hex": "#D2042D",
            "secondary_color_hex": "#FFA0A0",
            "is_active": 1,
            "image_url": "https://i.imgur.com/HnUrgWJ.png",
